...
public class XMLOutputDataCreator implements IOutputDataCreator
{
  ...
  public void init (@Nonnull @Nonempty final String sSourceDirectory)
  {
    ...
    m_aDoc.appendComment ("This file was automatically generated by ph-dirindex-maven-plugin. Please do NOT edit!");

    m_eRoot = m_aDoc.appendElement ("index");
  ...
  {
    final IMicroElement eDir = m_eRoot.appendElement ("directory");
  ...
  {
    final IMicroElement eFile = m_eRoot.appendElement ("file");
